 ...
 *
 * Ported from Persian-Bot/Cat-Bot (packages/cat-bot/src/engine/adapters/platform/telegram/utils/markdownv2.util.ts)
 * and adapted to this project's simpler, dependency-free module layout — the
 * logic itself is unchanged, since it never depended on grammy or any other
 * Cat-Bot-specific plumbing to begin with.
 *
 * Official Bot API MarkdownV2 spec (core.telegram.org/bots/api#markdownv2-style):
 *
 ...
 *
 * Supported formatting patterns (Telegram MarkdownV2):
 ...
 * command modules in this codebase write the more familiar CommonMark syntax.
 *
 * Three exports:
